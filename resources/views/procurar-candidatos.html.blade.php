    ...
    <body class="bg-gray-100 p-8">
        <div class="max-w-lg mx-auto bg-white p-6 rounded-lg shadow-lg">
            ...
            <form action="#" method="POST">
                ...
                <input type="text" name="foto" class="w-full border border-gray-300 p-2 rounded-md mb-4" required>
            ...
            <a href="index.html" class="block mt-4 text-center text-blue-600 hover:underline">Voltar</a>
        </div>
    </body>
    </html>
